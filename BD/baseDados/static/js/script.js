...
function renderTable() {
  ...
  for (let i = start; i < end; i++) {
    ...
    const inicioFormatado = new Date(datasInicio[i]).toLocaleDateString('pt-PT', { year: 'numeric', month: '2-digit', day: '2-digit' });
    const fimFormatado = new Date(datasFim[i]).toLocaleDateString('pt-PT', { year: 'numeric', month: '2-digit', day: '2-digit' });
